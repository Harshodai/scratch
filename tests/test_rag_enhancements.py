...
from centrag.abstractions.vectorstore import VectorSearchResult
...
class TestRAGEnhancements:
    ...
    async def test_contextual_compression_retrieval(self):
        ...
        # Mock chunks
        chunks = [
            SourceChunk(content="Chunk 1 content is here.", document_id="doc1", chunk_index=0, relevance_score=0.9, metadata={}),
            SourceChunk(content="Chunk 2 content is also here.", document_id="doc1", chunk_index=1, relevance_score=0.8, metadata={})
        ]
