...
1. **LLM Gateway** — circuit breaker, cost tracking, latency monitoring
2. **Conversation History** — session-aware retrieval
3. **OpenAI LLM** — production LLM implementation
